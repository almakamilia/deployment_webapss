...
if tombol:
    hitung_kadar_air_sampel = ((Bobot_awal_sampel - Bobot_konstan_sampel/Bobot_awal_sampel)*100)
    st.success(f"persentase kadar air sampel (%) sebesar... {round (hitung_kadar_air_sampel)}")
